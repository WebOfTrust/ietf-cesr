...
`&` represents one or more Base64 value characters representing the converted raw binary value.The actual number of chars is determined by the prepended text code.  
...
`%` means lead character.  
`&` represents one or more Base64 value characters representing the converted raw binary value. The actual number of chars is determined by the prep-ended text code.  
`TBD` means to be determined
